...
import com.example.nodemanager.ui.screens.detail.DetailScreen
import com.example.nodemanager.ui.screens.home.HomeScreen
import com.example.nodemanager.ui.screens.home.HomeViewModel
import com.example.nodemanager.ui.screens.login.LoginScreen
...
fun Navigation() {
    ...
    NavHost(navController= navController, startDestination = Screen.Login.route) {
        ...
        composable(Screen.Detail.route+"?noteIndex={noteIndex}",
            ...
            it.arguments?.getInt("noteIndex").let {
                index->
